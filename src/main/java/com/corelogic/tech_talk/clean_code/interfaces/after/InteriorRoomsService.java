...
import com.corelogic.tech_talk.clean_code.interfaces.helper.InteriorRoomsResponseData;
import com.corelogic.tech_talk.clean_code.interfaces.helper.Products;
import org.springframework.stereotype.Service;

@Service
public class InteriorRoomsService implements ExecutableBlockProductService, ClipRetrievalService<InteriorRoomsResponseData> {

    @Override
    public InteriorRoomsResponseData getByClip(String clip) throws  InterruptedException {
        return null;
    }
