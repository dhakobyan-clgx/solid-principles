...
import com.corelogic.tech_talk.clean_code.interfaces.helper.LotSizeResponseData;
import com.corelogic.tech_talk.clean_code.interfaces.helper.Products;
import org.springframework.stereotype.Service;

@Service
public class LotSizeService implements ExecutableBlockProductService, ClipRetrievalService<LotSizeResponseData> {

    @Override
    public LotSizeResponseData getByClip(String clip) throws  InterruptedException {
        return null;
    }
