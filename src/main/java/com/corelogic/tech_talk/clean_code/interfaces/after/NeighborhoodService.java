...
import com.corelogic.tech_talk.clean_code.interfaces.helper.NeighborhoodResponseData;
import com.corelogic.tech_talk.clean_code.interfaces.helper.Products;
import org.springframework.stereotype.Service;

@Service
public class NeighborhoodService implements ExecutableBlockProductService, ClipRetrievalService<NeighborhoodResponseData> {

    @Override
    public NeighborhoodResponseData getByClip(String clip) throws InterruptedException {
        return null;
    }
